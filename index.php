...
<body>
  ...
  <nav class="navbar">
    ...
    <!-- Navigation Links -->
    <div class="nav-links">
      <a href="#home" class="nav-link"><i class="fa fa-home" aria-hidden="true"></i> Home</a>
      ...
      <a href="feedback.html" class="nav-link"><i class="fa-solid fa-comments"></i> Feedback</a>
  ...
  <div class="alert">
    ...
    <span>
      ...
      <a href="#" target="_blank">Klik disini untuk menghubungi Admin Discord</a>
    </span>
  ...
  <div class="mode-container">
    <div class="mode-header">
      ...
      <div class="mode-list">
        <!-- Game Mode Item -->
        <div class="mode-item">
          <img src="assets/image/icon/money-bag-svgrepo-com.png" alt="" class="logo-survival-economy" />
          <p class="mode-deskripsi">Survival Economy</p>
        </div>
        <div class="mode-item">
          <img src="assets/image/icon/appartment-3-svgrepo-com.png" alt="" class="logo-skyblock" />
